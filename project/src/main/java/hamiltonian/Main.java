...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		// Set window title
		primaryStage.setTitle("Shortest Hamiltonian Path in a Complete Graph");
		...
		// Application icon
		primaryStage.getIcons().add(new Image(Objects.requireNonNull(Main.class.getClassLoader().getResourceAsStream("icon.png"))));
